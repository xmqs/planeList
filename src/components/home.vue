    ...
    <div class="page-tab-container">
      <div style="width: 100%;" class="">
        ...
        <div id="io" class="block">
          <div
            style="height: 61px;font-size: 18px;color: #333;border-bottom: 1px solid #f5f5f5;border-top: 10px solid #f5f5f5;line-height: 50px;margin-top: -7px;">
            <ul>
              <li class="tab" :class="{'mybottom':active === 'tab-container1'}" @click="selectmenu('tab-container1')">
                进出口货物
              </li>
              <li class="tab" :class="{'mybottom':active === 'tab-container2'}" @click="selectmenu('tab-container2')">
                出入境人员
              </li>
              <li class="tab" :class="{'mybottom':active === 'tab-container3'}" @click="selectmenu('tab-container3')">
                运输工具
              </li>
            </ul>
          </div>
          ...
          <el-carousel @change="handleChange" :autoplay="true" :interval="4500" arrow="never">
            <el-carousel-item>
              ...
              <div @click="godetails('tab1')">
                <div class="quantum"><span>进出口货物量（万吨）-{{fmonth}}月</span><span
                  class="numbers">总量{{freightTotalNum}}</span></div>
                <div class="topway">
                  <div class="way">
            ...
            <el-carousel-item>
              ...
              <div @click="godetails('tab2')">
                <div class="quantum"><span>出入境人员总数（万人次）-{{pmonth}}月</span><span
                  class="numbers">总量{{personTotalNum}}</span></div>
                <div class="topway">
            ...
            <el-carousel-item>
              ...
              <div @click="godetails('tab3')">
                <div class="quantum"><span>进出境运输工具（辆艘）-{{tmonth}}月</span><span
                  class="numbers">总量{{transTotalNum}}</span></div>
                <div class="topway">
                  <div style="width:49%" class="way">
                    <div class="way_ele0"><img class="chuan" src="../../static/img/kasj/chuan.png" alt=""></div>
...
<script scoped>
  ...
  export default {
    ...
    methods: {
      test(){
        window.location = "http://192.168.0.222:9900/#/eportMap?navigatorList=true";
      },
      godetails(n) {
      ...
      getlist() {
        ...
        axios.get('/eport-server/index/menu/query.do?channel=MYNJ', {}).then(function (res) {
